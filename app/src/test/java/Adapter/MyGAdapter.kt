...
class MyGAdapter(private val context: Context,private val movieList: MutableList<G>):RecyclerView.Adapter<MyGAdapter.MyViewHolder>() {

    class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){

        val txt_name: TextView = itemView.txt_name
        val txt_team: TextView = itemView.txt_team
        val file: TextView = itemView.file
